...
# --- 1. Configuração e Criação da Pasta ---
...
# --- 6. (Passo 3) Avaliação Treino vs Validação ---
results = {}
...
# --- 7. (Passo 4) Validação Cruzada K-Fold ---
k = 5
...
# --- 9. (Passo 6) Teste de Generalização ---
noise_level = 0.2
...
# --- 11. (Entregável 2) Tabela Comparativa Final ---
...
# --- 12. Salvar Tabela como Imagem ---
fig, ax = plt.subplots(figsize=(14, 4)) # Tamanho ajustado
ax.axis('tight')
ax.axis('off')

# Formatar os valores do DataFrame para 4 casas decimais
...
# Imprimir a tabela no console também
